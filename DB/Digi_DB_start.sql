...
--
-- Host: 127.0.0.1    Database: digitools
-- ------------------------------------------------------
...
--
-- Table structure for table `digi_user`
--

DROP TABLE IF EXISTS `digi_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `digi_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `digi_user`
--
